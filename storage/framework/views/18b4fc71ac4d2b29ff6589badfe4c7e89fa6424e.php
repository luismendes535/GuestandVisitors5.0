        ...
        <div class="row">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                            <div class="panel-heading"><span class="glyphicon glyphicon-blackboard"></span>  Add external visitor:</div>
                    ...
                    <form  class="form-horizontal" role="form" method="POST" action="<?php echo e(route('visitors.store')); ?>" data-parsley-validate="" onsubmit="return ConfirmExternVisitor()">
                            <input id="idMeeting" name="idMeeting" type="number"  value="<?php echo e($meeting->idMeeting); ?>"/>
