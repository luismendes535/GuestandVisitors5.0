    ...
    <?php if(!$meeting->isEmpty()): ?>

    <div class="col-md-8"   ng-controller="ShowController" >
        <div class="panel panel-default" >
         <div class="panel-heading"><span class="glyphicon glyphicon-blackboard"></span> Create External Visitor</div>

         <div class="container"  >

             <div class="btn-group" >  
                <button style="width:150px;" class="btn btn-default btn-xs btn-block panel-heading" ng-click="ShowHide()" value="" > 
    ...
    <div class="col-md-8" ng-controller="ShowController" >
        <div class="panel panel-default">
           <div class="panel-heading" ><span class="glyphicon glyphicon-blackboard"></span> Create Internal Visitor</div>


           <div class="container"  >

             <div class="btn-group " >  
             <button style="width:150px;" class="btn btn-default btn-xs btn-block panel-heading" ng-click="ShowHide()"  ng-model="button" > 
